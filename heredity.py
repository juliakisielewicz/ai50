...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        #assuming there is always info about both parents or neither
        if people[person]["mother"] is None:
            jprob *= PROBS["gene"][gene]
            ...
            if gene == 0:
                    jprob *= (1 - from_mother) * (1 - from_father)
            elif gene == 1:
                    jprob *= from_mother * (1 - from_father) + (1 - from_mother) * from_father
            elif gene == 2:
                    jprob *= from_mother * from_father

        trait = person in have_trait
        jprob *= PROBS["trait"][gene][trait]
